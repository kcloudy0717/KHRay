...
template<typename T>
[[nodiscard]] Vector3<T> operator*(T s, const Vector3<T>& v)
{
	return v * s;
}
...
template<typename T>
[[nodiscard]] T Dot(const Vector3<T>& v1, const Vector3<T>& v2)
{
	return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
}

template<typename T>
[[nodiscard]] T AbsDot(const Vector3<T>& v1, const Vector3<T>& v2)
{
	return std::abs(Dot(v1, v2));
}

template<typename T>
[[nodiscard]] Vector3<T> Cross(const Vector3<T>& v1, const Vector3<T>& v2)
{
...
template<typename T>
[[nodiscard]] Vector3<T> Faceforward(const Vector3<T>& n, const Vector3<T>& v)
{
	return (Dot(n, v) < 0.0f) ? -n : n;
}

template<typename T>
[[nodiscard]] float DistanceSquared(const Vector3<T>& p1, const Vector3<T>& p2)
{
